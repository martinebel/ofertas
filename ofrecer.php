                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box">
                                    ...
                                    <h4 class="page-title">Hay que Ofrecer</h4>
                                </div>
                            </div>
                        </div>
                        <!-- end page title -->
                          ...
                          <div class="table-responsive">
                            <table class="table table-centered  table-sm table-striped mb-0" id="data-table">
                              ...
                              <tbody>
                                  ...
                                  <?php
                                  $stmt = sqlsrv_query( $conn, "select Publicaciones.*,productos.prodescripcion,productos.prostockactual,(select top 1 imagenes_temp.id_imagen from imagenes_temp where id_producto=publicaciones.procodigo) as imagen from Publicaciones inner join productos on productos.procodigo=publicaciones.procodigo where tipo=2");
