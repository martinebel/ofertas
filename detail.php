                              ...
                              <div class="card-body">
                                <div class="row">
                                  ...
                                  <div class="col-lg-7">
                                    <form class="pl-lg-4">
                                      ...
                                      <?php
                                      //datos del producto
                                      $stmt = sqlsrv_query( $conn, "select Publicaciones.*,productos.descripcion,productos.prodescripcion,productos.prostockactual,(select top 1 imagenes_temp.id_imagen from imagenes_temp where id_producto=publicaciones.procodigo) as imagen from Publicaciones inner join productos on productos.procodigo=publicaciones.procodigo where productos.procodigo=".$_REQUEST["id"]);
                                      ...
                                      <p class="mb-1">Agregado <?php echo $fecha;?></p>
                                ...
                                <div class="table-responsive mt-4">
                                  <!-- Product information -->
                                    ...
                                    <div class="row">
                                      <div class="col-md-4">
                                        <h6 class="font-14">Condiciones de Pago:</h6>
                                        <p><?php echo $pago;?></p>
                                      </div>
                                      <div class="col-md-4">
                                        <h6 class="font-14">Condiciones de Entrega:</h6>
